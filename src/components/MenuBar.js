            ...
            <HideOnScroll {...props}>
                <AppBar className={classes.appbar} >
                    <Toolbar>
                        ...
                        <IconButton color="inherit" target="_blank" href="https://github.com/WeiPhil">
                            <GitHubIcon className={classes.icon}></GitHubIcon>
                        </IconButton>
                        <IconButton color="inherit" target="_blank" href="https://ch.linkedin.com/in/philippe-weier-5125a2165">
                            <LinkedInIcon className={classes.icon}></LinkedInIcon>
                        </IconButton>
                        <IconButton color="inherit" target="_blank" href="https://twitter.com/PhilippeWeier">
