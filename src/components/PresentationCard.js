          ...
          <Grid container direction="column" alignItems="center">
            <Grid item style={{ paddingTop: smallWidth ? 15 : 5, }}>
              ...
              <Typography variant="subtitle1" color="textSecondary" gutterBottom style={{ marginTop: 30 }}>
                I recently finished my Master in Computer Science and Communication at <StyledLink target='_blank' href="https://www.epfl.ch/">EPFL</StyledLink> and currently working on Light Transport at <StyledLink target='_blank' href="https://www.wetafx.co.nz/">Weta Digital</StyledLink> as a rendering researcher.
              </Typography>
